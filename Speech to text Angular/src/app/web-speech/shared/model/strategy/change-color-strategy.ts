...
export class ChangeColorStrategy extends ActionStrategy {
    ...
    constructor() {
        ...
        this.mapInitResponse.set('en-IN', 'activar color');
        ...
        this.mapActionDone.set('en-IN', 'activar color');
        ...
        this.mapFinishResponse.set('en-IN', 'Cambiando el color de tema a');
